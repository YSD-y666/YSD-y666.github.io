...
*/
/* jquery-core: (http://5b9732f9943c7.t73.qifeiye.com/qfy-includes/js/jquery/jquery.js) */
...
/* jquery-migrate: (http://5b9732f9943c7.t73.qifeiye.com/qfy-includes/js/jquery/jquery-migrate.min.js) */
...
/* qfe_composer_front_js: (http://5b9732f9943c7.t73.qifeiye.com/qfy-content/plugins/qfy_editor/assets/js/qfy_editor_front.js) */
...
/* vc_transition_bootstrap_js: (http://5b9732f9943c7.t73.qifeiye.com/qfy-content/plugins/qfy_editor/assets/lib/vc_carousel/js/transition.js) */
+function ($) { "use strict";
...
/* vc_carousel_js: (http://5b9732f9943c7.t73.qifeiye.com/qfy-content/plugins/qfy_editor/assets/lib/vc_carousel/js/vc_carousel.js) */
/* ========================================================================
...
/* waypoints: (http://5b9732f9943c7.t73.qifeiye.com/qfy-content/plugins/qfy_editor/assets/lib/jquery-waypoints/waypoints.min.js) */
...
/* jquery-blockui: (http://5b9732f9943c7.t73.qifeiye.com/qfy-content/plugins/bitcommerce/assets/js/jquery-blockui/jquery.blockUI.min.js) */
/*!
...
/* dt-plugins: (http://5b9732f9943c7.t73.qifeiye.com/qfy-content/themes/qfy-01/js/plugins.js) */
/*jquery-parallax*/
/*scroll 用到*/
...
/* dt-main-op-jquery: (http://5b9732f9943c7.t73.qifeiye.com/FeiEditor/bitSite/js/opentip-jquery.min.js) */
// Opentip v2.4.6
...
/* dt-language: (http://5b9732f9943c7.t73.qifeiye.com/qfy-content/themes/qfy-01/js/language.js) */
jQuery(function(){
...
/* dt-main: (http://5b9732f9943c7.t73.qifeiye.com/qfy-content/themes/qfy-01/js/main.js) */
//悬浮效果
...
function qfy_template_preiview_fun(url,select_url){
	...
	jQuery("body").append("<div id='qfy_template_preivew'><div id='qfy_template_preivew_header'><span style='float:left;' > <span class='back' style='position: relative;top:-6px;font-size:12px;'><svg style='position: relative;top:2px;margin-right:3px;stroke: #222;stroke-width: 7px;width: 14px;overflow: visible;-webkit-transform: scaleX(-1);transform: scaleX(-1);' width=\"8px\" height=\"13px\" viewBox=\"0 0 8 13\" version=\"1.1\"><g style='fill: #222;' id=\"Visual-Design\" stroke=\"none\" stroke-width=\"1\" fill=\"none\" fill-rule=\"evenodd\" opacity=\"1\"><g id=\"9b\" transform=\"translate(-344.000000, -357.000000)\" fill=\"#222222\"><g id=\"templates\" transform=\"translate(-202.000000, 165.000000)\"><path d=\"M544,195 L544,203 L543,203 L543,195 L543,194 L552,194 L552,195 L544,195 Z\" id=\"Combined-Shape\" transform=\"translate(547.500000, 198.500000) rotate(-225.000000) translate(-547.500000, -198.500000) \"></path></g></g></g></svg>返回 </span> <svg class='pc selected'  width=\"28\" height=\"22\" viewBox=\"0 0 28 22\" xmlns=\"http://www.w3.org/2000/svg\"><g fill=\"#000\" fill-rule=\"evenodd\"><path d=\"M11 18h1v4h-1z\"></path><path d=\"M9 21h10v1H9z\"></path><path d=\"M16 18h1v4h-1z\"></path><path d=\"M1 3v13c0 1.11.891 2 1.996 2h22.008A2.004 2.004 0 0 0 27 16V3c0-1.11-.891-2-1.996-2H2.996A2.004 2.004 0 0 0 1 3zM0 3c0-1.657 1.35-3 2.996-3h22.008A2.994 2.994 0 0 1 28 3v13c0 1.657-1.35 3-2.996 3H2.996A2.994 2.994 0 0 1 0 16V3z\"></path></g></svg><svg class='tablet' width=\"20\" height=\"28\" viewBox=\"0 0 20 28\" xmlns=\"http://www.w3.org/2000/svg\"><g fill=\"#000\" fill-rule=\"evenodd\"><path d=\"M1 2.996v22.008C1 26.1 1.897 27 2.994 27h14.012c1.1 0 1.994-.895 1.994-1.996V2.996A2.001 2.001 0 0 0 17.006 1H2.994C1.894 1 1 1.895 1 2.996zm-1 0A2.997 2.997 0 0 1 2.994 0h14.012A3.001 3.001 0 0 1 20 2.996v22.008A2.997 2.997 0 0 1 17.006 28H2.994A3.001 3.001 0 0 1 0 25.004V2.996z\"></path><path d=\"M9 23h2v2H9z\"></path></g></svg><svg class='mobile' width=\"12\" height=\"22\" viewBox=\"0 0 12 22\" xmlns=\"http://www.w3.org/2000/svg\"><g fill=\"#000\" fill-rule=\"evenodd\"><path d=\"M1 3.001V19C1 20.105 1.894 21 2.997 21h6.006A2 2 0 0 0 11 18.999V3A1.999 1.999 0 0 0 9.003 1H2.997A2 2 0 0 0 1 3.001zm-1 0A3 3 0 0 1 2.997 0h6.006A2.999 2.999 0 0 1 12 3.001V19A3 3 0 0 1 9.003 22H2.997A2.999 2.999 0 0 1 0 18.999V3z\"></path><path d=\"M5 18h2v2H5z\"></path></g></svg> </span>  <span  style='float:right;'><a class='preivew' target='_blank' href='"+url+"'>访问演示网站</a><a href='"+select_url+"'><button class='use'>选用</button></a></span></div><div id='qfy_template_preivew_content' style='transform:translateY(0px) scale(1);'><div class='iframe-inner'>"+header_str+"<iframe src='"+url+"'></iframe></div></div><div class='loading-iframe'></div></div>");
	...
	if(b_width<1440 || b_height<800){
		...
		jQuery("#qfy_template_preivew_content").css("transform","translateY(0px) scale("+b+")");
	}
	jQuery("#qfy_template_preivew .pc").click(function(){
		jQuery("#qfy_template_preivew svg.pc").attr("class","pc selected");
		jQuery("#qfy_template_preivew svg.tablet").attr("class","tablet");
		jQuery("#qfy_template_preivew svg.mobile").attr("class","mobile");
		jQuery("#qfy_template_preivew .iframe-inner").animate({"width":1440,"height":800},"fast");
	});
	jQuery("#qfy_template_preivew .tablet").click(function(){
		jQuery("#qfy_template_preivew svg.pc").attr("class","pc");
		jQuery("#qfy_template_preivew svg.tablet").attr("class","tablet selected");
		jQuery("#qfy_template_preivew svg.mobile").attr("class","mobile");
		jQuery("#qfy_template_preivew .iframe-inner").animate({"width":768,"height":800},"fast");
	});
	jQuery("#qfy_template_preivew .mobile").click(function(){
		jQuery("#qfy_template_preivew svg.pc").attr("class","pc");
		jQuery("#qfy_template_preivew svg.tablet").attr("class","tablet");
		jQuery("#qfy_template_preivew svg.mobile").attr("class","mobile selected");
...
/* thickbox: (http://5b9732f9943c7.t73.qifeiye.com/qfy-includes/js/thickbox/thickbox.js) */
/*
...
/* jquery-lazy: (http://5b9732f9943c7.t73.qifeiye.com/qfy-includes/js/jquery.lazy.min.js) */
